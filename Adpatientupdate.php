...
if (isset($_POST['btnupdate']))
{
   ...
   if($result)
   {
    echo "<script>alert('Update Completed.');window.location.assign('patientlist.php')</script>";
    }
    else
    {
      echo "Incomplete.";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        ...
                        <form action="Adpatientupdate.php" method="POST" enctype="multipart/form-data">
